    ...
    object Intention {
      ...
      def apply(): Behavior[IGoalMessage] = Behaviors.receive {
        (context, message) => message.goal() match {
              ...
              case GeneratedAgent1.m_goal_1 =>
                   GeneratedAgent1.m_goal_1.execute(context,message.params().asInstanceOf[GeneratedAgent1.m_goal_1.Parameters])

              case GeneratedAgent1.m_goal_2 =>
                   GeneratedAgent1.m_goal_2.execute(context,message.params().asInstanceOf[GeneratedAgent1.m_goal_2.Parameters])
